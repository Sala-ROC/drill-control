...
// --- DATA MIGRATION FROM EXCEL 5/22/26 (CORRECTED) ---
if (!localStorage.getItem('drill_excel_migration_v322b')) {
    ...
    rigsData.forEach(r => {
        if (excelData[r.id]) {
            ...
            db.collection('rigs').doc(r.id).set(r);
        }
    });
    localStorage.setItem('drill_rigs_data', JSON.stringify(rigsData));
    localStorage.setItem('drill_excel_migration_v322b', 'true');
    console.log("Excel migration v322b completed!");
}
// --- END MIGRATION ---
